  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        ...
        <div className='max-h-screen min-h-screen min-w-screen max-w-screen relative overflow-hidden flex' style={{backgroundColor: 'var(--global-background-color)', backdropFilter:'blur(0px)'}}>
          {children}
        </div>
      </body>
    </html>
