...
import { StationNotFoundError, StationQueueIsEmptyError, StationTrackSwitchRequestTooEarlyError } from "@/app/shared-api/other/errors";
...
export async function popStationTrack(stationId: StationId)
{
...
export async function moveStationToNextTrack(stationId: StationId, skipValidation: boolean = false)
{
    ...
    const poppedTrack = await popStationTrack(stationId);
